...
(() => {
  ...
  Game_Map.prototype.changeBattleback = function (
    ...
    rx_t_gmpp151026_changeBattleback.call(
      this,
      battleback1Name,
      battleback2Name
    );
  ...
  const rx_t_spbp151026_updateBattleback =
  ...
  if (PluginManager._commands !== undefined) {
    ...
    //Game_Interpreter
    const rx_t_gipc200911_pluginCommand =
      ...
      if (command === "battleback") {
        switch (args[0]) {
          ...
          case "復帰":
            ...
            if (
              $gameParty.inBattle() &&
              !$gameTemp._rx_changeBatBack_in_battle
            ) {
              $gameTemp._rx_changeBatBack_in_battle = true;
            }
            break;
